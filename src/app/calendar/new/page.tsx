          ...
          <div>
            ...
            <div className="flex gap-2 w-full">
              <select
                ...
                className="flex-1 min-w-0 px-3 py-3.5 rounded-xl border border-gray-200 bg-white text-[15px] text-picks-dark focus:border-picks-rose transition-colors appearance-none"
              >
